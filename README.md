...
- 개인정보처리방침 (KO): https://studiovarem-ui.github.io/expolog-site/privacy/ko/

`privacy/` is generated from the app repo (`scripts/build-privacy-pages.mjs`); edit the Markdown there and copy the output here.
